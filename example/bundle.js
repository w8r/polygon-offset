...
(function (L) {
   ...
   * @return {Object}
   */
  Edge.prototype.inwardsNormal = function inwardsNormal () {
    var dx = this.next[0] - this.current[0];
    var dy = this.next[1] - this.current[1];
  ...
  src.diff = diff;
  src.xor = xor;
  src.intersection = intersection_1;
  src.operations = operations;
  src.fillQueue = fillQueue_1;
  src.computeFields = computeFields_1;
  src.subdivideSegments = subdivideSegments_1;
  src.divideSegment = divideSegment_1;
  src.possibleIntersection = possibleIntersection_1;

  var martinezPolygonClipping = src;
   ...
   * @return {*}
   */
  function orientRings(coordinates, depth, isHole) {
    depth = depth || 0;
    var i, len;
   ...
   * @param{Array} edges
   */
  Offset.prototype._processContour = function _processContour (contour, edges) {
    var i, len;
   ...
   * @return {Offset}
   */
  Offset.prototype.arcSegments = function arcSegments (arcSegments$1) {
    this._arcSegments = arcSegments$1;
    return this;
  };
   ...
   * @return {Offset}
   */
  Offset.prototype.distance = function distance (dist, units) {
   ...
   * @return {Array.<Object>}
   */
  Offset.prototype.offsetLine = function offsetLine (dist) {
    if (dist === 0) { return this.vertices; }
   ...
   */
  Offset.prototype.offsetLines = function offsetLines (dist) {
   ...
   * @return {Polygon}
   */
  Offset.prototype.offsetContour = function offsetContour (curve, edges) {
    var union, i, len;
   ...
   * @return {Array.<Array.<Number>}
   */
  Offset.prototype.offsetPoint = function offsetPoint (distance) {
  ...
  var geojsonProject = createCommonjsModule(function (module) {
  /**
